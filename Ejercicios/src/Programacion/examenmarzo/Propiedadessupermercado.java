...
public class Propiedadessupermercado {
	 ...
	 *  y su correspondiente contraseña.*/
		...
		public Propiedadessupermercado() {
		super();
		...
		private static Properties getPropiedades() {
			if (propiedades == null) {
				...
				try {
					propiedades.load(propiedades.getClass().getResourceAsStream("/Programacion/examenmarzo/propiedades"));

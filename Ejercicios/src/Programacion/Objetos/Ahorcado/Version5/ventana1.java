...
public class ventana1 extends Canvas {
	...
	public BufferedImage getImagen(String nombre) {
		URL url=null;
		try {
			url = getClass().getResource("/Programacion/Objetos/Ahorcado/Version5/" + nombre);
	...
	public void paint(Graphics g) {
		...
		if (Jugador.intento.equals(Jugador.palabra)|| Jugador.terminadoporletra==true) {
			g.drawString("¡Felicidades, has acertado!", 100, 380);
		}
		if (Jugador.contadorfallos==6) {
			g.drawString("¡Perdiste marinero!, la palabra correcta era: "+Jugador.palabra, 100, 380);
		}
	}

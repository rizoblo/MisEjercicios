...
//singleton
	...
	public static void generacionpalabra() {
		...
		//Cheat de pista
				if (intento.equals(palabracheto)) {
					if (chetoactivado==false){	
						chetoactivado=true;
						System.out.println();
		//Elección de la letra al azar que será una pista
		...
		//En caso de que sea un acierto, será añadida
				...
				{
		//Comprobación de si la palabra introducida por el jugador es acertada, y felicitarle por ello
					...
					{
		//En caso contrario, decir que la palabra introducida es errónea, y sumar fallo. Excluimos los casos de las palabras que utilizamos para activar los cheats
						if (!(intento.equals(palabracheto)) && mododiosactivado==false) {
